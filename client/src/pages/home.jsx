...
export function Home() {
    ...
    return (
        <>
            ...
            <section className="relative mx-auto my-10 flex h-96 items-center bg-[url(https://dony-client.vercel.app/img/bg-home-2.jpg)] bg-cover bg-scroll bg-center bg-no-repeat px-4 py-20">
