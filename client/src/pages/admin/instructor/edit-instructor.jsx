            ...
            <Card className="mx-auto max-w-3xl p-6 dark:bg-[#25303F]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <Input type="text" name="name" value={formData.name} onChange={handleInputChange} required className="bg-gray-50 dark:text-white" placeholder="Nom de l'instructeur" />
                    </div>
                    ...
                    <div>
                        ...
                        <Textarea name="biography" value={formData.biography} onChange={handleInputChange} required placeholder="Biographie de l'instructeur" className="bg-gray-50 dark:text-white" rows={6} />
                    </div>
                    ...
                    <div>
                        ...
                        {preview ? <img src={preview} alt="Aperçu" className="mt-2 max-w-xs rounded-lg shadow-lg" /> : currentImage && <img src={`${BASE_URL}${currentImage}`} alt="Image actuelle" className="mt-2 max-w-xs rounded-lg shadow-lg" />}
                    </div>

                    <div className="flex justify-end gap-4">
                        <Button variant="outlined" onClick={() => navigate("/administrator/instructors")} className="dark:bg-white dark:text-black">
                            Annuler
                        </Button>
