const generateInvoiceEmailTemplate = ({ fullname, product, payment, item, productTitle, startDate, startTime, link }) => {
    return `
<section class="px-6 py-8 mx-auto max-w-2xl bg-white dark:bg-gray-900">
  <main class="mt-8">
    <p>Bonjour ${fullname},</p>

    <div class="p-4 mt-6 bg-gray-100 rounded-lg dark:bg-gray-800">
    ...
    <a
      href="${product === "masterclass" ? link : `https://dony-client.vercel.app/detail/slug/${item.slug}`}"
      target="_blank"
      class="inline-block px-6 py-2 mt-4 text-white bg-blue-600 rounded hover:bg-blue-700"
    >
